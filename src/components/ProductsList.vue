            ...
            <v-hover v-slot="{ hover }">
              ...
              >
                ...
                <v-row>
                  ...
                  <v-col cols="6">
                    <v-card-title class="d-flex justify-end" v-if="item.descuento >= 1">
                      ${{ item.precio - ((item.descuento / 100) * item.precio) }}
                    </v-card-title>
                ...
                <v-card-actions>
                  ...
                  <p v-if="item.descuento >= 1" class="red--text">Descuento!</p>
                </v-card-actions>
              </v-card>
            </v-hover>
          </v-col>
